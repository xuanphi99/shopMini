				...
				<div class="collapse navbar-collapse itemmenu  "
					...
					<ul class="navbar-nav mr-auto  itemmenutrai wow fadeInDown  "
						...
						<li class="nav-item active"><a class="nav-link"
							href=' <c:url value="/trangchu"/>   '>Trang chủ <span
          ...
          <a class="dropdown-item" href="#">Something else here</a> -->
					...
					<ul class="navbar-nav itemphai ">
						<c:choose>
							...
							<c:otherwise>
								<li class="nav-item "><a class="nav-link LinkDangNhap"
						...
						<li class="nav-item ParentShoppingCast "><a
							class="logogioohang" href=' <c:url value="/giohang"/>   '> <img
								alt="anh bia"
		...
		<div class="container">
			<div class="chitietSanPham">
				<div class="row">
					...
					<div class=" col-md-8 pageDetail8 animate__zoomIn">
						<div class="row">
							<div class=" col-md-4 ">
								<a
									href=" <c:url value="/resources/Image/sanpham/${sanpham.getHinhSanPham() }"/> "
									class="work-image"> <img class="anhSPChitiet "
									data-urlAnhSP="<c:url value="/resources/Image/sanpham/${sanpham.getHinhSanPham() }"/>"
									src='<c:url value="/resources/Image/sanpham/${sanpham.getHinhSanPham() }"/>'
									alt="" />
								</a>
							</div>
							<div class=" col-md-8">
								<h3 class="tenspchitiet" data-masp="${sanpham.getMaSanPham() }">
									${sanpham.getTenSanPham() }</h3>
									...
									<tbody>
										...
										<c:forEach var="chitietsp" items="${sanpham.getLi()}">
											<tr>
												...
												<td class="size"
													data-machitiet="${chitietsp.getMachiTietSanPham() }"
													data-Masize="${ chitietsp.getSizeSanPham().getMaSize()} ">${chitietsp.getSizeSanPham().getSize() }</td>
												<td class="mau"
													data-MaMau="${ chitietsp.getMauSanPham().getMamau() } ">${chitietsp.getMauSanPham().getTenmau() }</td>
												<td class="amount" data-urlAnhSP="  ">
													${chitietsp.getSoluong() }</td>
												<td><button type="button"
														class="btn btn-danger Addtocast">Add to cast</button></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
					...
					<div class=" col-md-2 pageDetail2">
						<span class="mota">${sanpham.getMota() }</span>
					</div>

					<div class='clickdm col-md-10'>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-4 col-md-4 wow tada">
					...
					<span>43 Nam Giang Nam Trực Nam Định</span> <span>doanxuanphi@gmail.com</span>
